...
RESPONSÁVEIS PELO PROJETO: Bruna Danieli Ribeiro Gonçalves, Marlon Andrel Coelho Freitas.

NOME DO SISTEMA A SER DESENVOLVIDO: Softpapers automação de papelarias.

NECESSIDADE DA EMPRESA: Observando a maneira como são gerenciados os processos de uma papelaria, foi perceptível a dificuldade
...
REQUISITOS DO NEGÓCIO: O software deverá possuir um único ambiente em Desktop, desenvolvido na plataforma JAVA utilizando o
